...
<head>
    ...
    <link href="css/template_4.css" rel="stylesheet">
    ...
    <div id="capture_area">
      <div class="wrapper">
          ...
          <div id="right" class="container text-left">
            ...
            <h5 class="summary" id="summary">
            	<% out.print(personal.getString("summary")); %>
            </h5>
            ...
            <div class="sub_box">
              ...
              <h5 class="summary" id="experience_summary1"><% out.print(experience.getString("experience_summary1")); %></h5>
